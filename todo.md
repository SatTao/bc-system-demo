...
- Support Pimoni traffic lights thru their library - this may eventually be replaced with real stacklights.

- Prototype an xml/csv data export functionality - this may be the preferred long term method of pushing data. Might look like FTP drop xml to a folder for scheduled collection.
